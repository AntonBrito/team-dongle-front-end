...
// ///////////////////////////
var postsHandlebars = function postsHandlebars(title, body, dataId) {
  var postHandlebarsTemplate = __webpack_require__(18);
  var context = {
    'title': title,
    'body': body,
    'dataId': dataId
...
// ///////////////////////////
var pagesHandlebars = function pagesHandlebars(title, heading, body, footer, dataId) {
  var pageHandlebarsTemplate = __webpack_require__(35);
  var context = {
    'title': title,
    'heading': heading,
    'body': body,
  ...
  var html = pageHandlebarsTemplate(context);
  $('#pages-div').append(html);
};
// ////////////////////////////
// template context for drpdwn/
// ////////////////////////////
var dropdownHandlebars = function dropdownHandlebars(title, dataId) {
  var pageHandlebarsTemplate = __webpack_require__(36);
  var context = {
...
module.exports = {
  ...
  pagesHandlebars: pagesHandlebars,
...
var onSignIn = function onSignIn(event) {
  ...
  var data = getFormFields(this);
  event.preventDefault();
  api.signIn(data).then(ui.signInSuccess).then(onGetAllMyPages).catch(ui.signInFailure);
};
...
var onGetAllPosts = function onGetAllPosts(event) {
  event.preventDefault();
  api.getAllPosts().then(ui.getAllPostsSuccess).catch(ui.getAllPostsFailure);
};

var onGetAllMyPosts = function onGetAllMyPosts(event) {
  event.preventDefault();
  api.getAllMyPosts().then(ui.getAllMyPostsSuccess).catch(ui.getAllMyPostsFailure);
};
...
var onUpdatePost = function onUpdatePost(event) {
  ...
  event.preventDefault();
  api.updatePost(data, dataId).then(ui.editPostSuccess).catch(ui.editPostFailure);
};
...
var onGetAllPages = function onGetAllPages(event) {
  event.preventDefault();
  api.getAllPages().then(ui.getAllPagesSuccess).catch(ui.getAllPagesFailure);
};

var onGetAllMyPages = function onGetAllMyPages() {
  // event.preventDefault()
  api.getAllMyPages().then(ui.getAllMyPagesSuccess).catch(ui.getAllMyPagesFailure);
};

var onGetOnePage = function onGetOnePage(event) {
  console.log('onGetOnePage called');
  var dataId = this.getAttribute('data-id');
  console.log('dataId = ' + dataId);
  api.getOnePage(dataId).then(ui.getOnePageSuccess).catch(ui.getOnePageFailure);
};

var onCreatePage = function onCreatePage(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createPage(data).then(ui.createPageSuccess).then(onGetAllMyPages).catch(ui.createPageFailure);
};

var onUpdatePageSaveId = function onUpdatePageSaveId(event) {
  var dataId = this.getAttribute('data-id');
  console.log('onUpdatePostSaveId = ' + dataId);
  event.preventDefault();
...
var onUpdatePage = function onUpdatePage(event) {
  ...
  var dataId = this.getAttribute('data-id');
  event.preventDefault();
  api.updatePage(data, dataId).then(ui.updatePageSuccess).catch(ui.updatePageFailure);
};

var onDeletePage = function onDeletePage(event) {
  var dataId = this.getAttribute('data-id');
  event.preventDefault();
  api.deletePage(dataId).then(ui.deletePageSuccess).then(onGetAllMyPages).catch(ui.deletePageFailure);
};
...
module.exports = {
  ...
  onGetAllPages: onGetAllPages,
  onGetAllMyPages: onGetAllMyPages,
  onCreatePage: onCreatePage,
  onUpdatePageSaveId: onUpdatePageSaveId,
  onUpdatePage: onUpdatePage,
  onGetOnePage: onGetOnePage,
...
var getAllMyPages = function getAllMyPages() {
  return $.ajax({
...
var getOnePage = function getOnePage(dataId) {
...
var deletePage = function deletePage(dataId) {
  return $.ajax({
    url: app.host + '/pages/' + dataId,
    method: 'DELETE',
    headers: {
...
var updatePage = function updatePage(data, dataId) {
  console.log('update post data = ' + data);
  console.log('update post dataId = ' + dataId);
  return $.ajax({
    url: app.host + '/pages/' + dataId,
...
var getAllPostsSuccess = function getAllPostsSuccess(data) {
  console.log(data);
  console.log('Successfully retrieved all posts by all users');
  $('#post-div').empty();
  for (var i = 0; i < data.posts.length; i++) {
    var title = data.posts[i].title;
    var body = data.posts[i].body;
    var dataId = data.posts[i]._id;
    template.postsHandlebars(title, body, dataId);
  }
  $('.postsEditButton, .postsDeleteButton').hide();
};
var getAllPostsFailure = function getAllPostsFailure(err) {
  console.log(err);
...
var getAllMyPostsSuccess = function getAllMyPostsSuccess(data) {
  console.log(data);
...
var getAllMyPostsFailure = function getAllMyPostsFailure(error) {
  console.log('Failed');
  $('#post-div').html('These Are Not The Posts You Are Looking For');
  console.log(error);
};

var getAllPagesSuccess = function getAllPagesSuccess(data) {
  app.pages = data.pages;
  console.log(app.pages);
  console.log('Succeded in getAllPagesSuccess');
};

var getOnePageSuccess = function getOnePageSuccess(data) {
  ...
  var heading = data.page.sections.heading;
  var body = data.page.sections.body;
  var footer = data.page.sections.footer;
  var dataId = data.page._id;
  console.log(title + heading + body + footer + dataId);
  template.pagesHandlebars(title, heading, body, footer, dataId);
};

var getAllPagesFailure = function getAllPagesFailure(error) {
  console.log(error);
  console.log('Failed in getAllPagesFailure');
};

var getAllMyPagesSuccess = function getAllMyPagesSuccess(data) {
...
var getAllMyPagesFailure = function getAllMyPagesFailure(error) {
  console.log(error);
...
module.exports = {
  ...
  getAllPagesFailure: getAllPagesFailure,
  getOnePageSuccess: getOnePageSuccess,
  getAllMyPagesSuccess: getAllMyPagesSuccess,
  getAllMyPagesFailure: getAllMyPagesFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- pages template -->\n  <div id=\"pages-content\" data-id=\""
    ...
    + "</p>\n    <button type=\"button\" class=\"pagesEditButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\" name=\"editButton\">Edit</button>\n    <button type=\"button\" class=\"pagesDeleteButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\" name=\"deleteButton\">Delete</button>\n  </div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- pages dropdown list template -->\n<div id=\"pages-dropdown-page-list\">\n  <p id='pages-dropdown-page-title' data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\">"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</p>\n</div>\n";
